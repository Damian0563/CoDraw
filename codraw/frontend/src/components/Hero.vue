<template>
		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-3 mb-3" v-for="(feature, i) in features" :key="i">
					<div class="card feature-card h-100 bg-dark text-white shadow-lg scroll-reveal"
	...
	<section class="about-sec container text-center my-5 scroll-reveal" aria-label="Our mission">
		<text class="about-title">No subscriptions, no hidden fees</text><text class="about-text"
			style="font-size: 2.5rem;">- just free for everyone, forever with at most respect to privacy.</text>
	</section>
		...
		<div class="container">
			<div class="row align-items-center">
				...
				<div class="col-md-6 text-center about-visual scroll-reveal" style="transition-delay: 200ms;">
					<img :src="logo" alt="Collaborative Drawing" class="about-image" loading="lazy" decoding="async" />
				</div>
			</div>
		</div>
	</section>
			...
			<div class="row justify-content-center">
				<div class="col-lg-8">
					<div class="accordion" id="faqAccordion">
						<div class="accordion-item faq-item scroll-reveal" v-for="(faq, index) in faqs" :key="index"
